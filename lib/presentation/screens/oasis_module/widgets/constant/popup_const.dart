...
class OnclickPopupsroll extends StatelessWidget {
  final double width;
  final double? height;
  final String title;
  final List<Widget> itembody;
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: Container(
        width: width,
        height: height ?? 500,  // Default height is set to 500
        decoration: BoxDecoration(
          color: ColorManager.white,
          borderRadius: BorderRadius.circular(8),
        ),
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(title, style: BoldfontStyle.customTextStyle(context)),
                            IconButton(
                              splashColor: Colors.transparent,
                              highlightColor: Colors.transparent,
                              hoverColor: Colors.transparent,
                      ...
                      Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Item Intent', style: BoldfontStyle.customTextStyle(context)),
                            SizedBox(height: AppSize.s10),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: itembody,
                            ...
                            SizedBox(height: AppSize.s20),
                            Text('Response - Specific Instructions', style: BoldfontStyle.customTextStyle(context)),
                            SizedBox(height: AppSize.s10),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: responsebody,
