            ...
            Row(
              ...
              children: [
                _buildTextField(
                  ...
                  labelText: "Name",
                  errorKey: 'name',
                  capitalIsSelect: false, hintText: 'Enter Name',
                ),
                _buildTextField(
                ...
                _buildTextField(
                  ...
                  capitalIsSelect: false, hintText: 'Enter Title',
                ),
              ],
            ),
            SizedBox(height: MediaQuery.of(context).size.height / 20),
            Row(
              ...
              children: [
                _buildTextField(
                  ...
                  errorKey: 'knowPerson',
                  capitalIsSelect: false, hintText: 'Enter Text',
                ),
                _buildTextField(
                  controller: widget.companyNameController,
                  labelText: "Company",
                  errorKey: 'companyName',
                  capitalIsSelect: false, hintText: 'Enter Company',
                ),
                _buildTextField(
                  controller: widget.associationLengthController,
                  labelText: "Length of Association",
                  errorKey: 'associationLength',
                  capitalIsSelect: false, hintText: 'Enter Length of Association',
                ),
              ],
            ),
            SizedBox(height: MediaQuery.of(context).size.height / 20),
