                        ...
                        Flexible(
                          ...
                          Flexible(
                              child: SchedularTextField(
                                  ...
                                  labelText: "Email")),
                        //  SizedBox(width: AppSize.s35),
                          providerState.isContactTrue ? SizedBox(width: AppSize.s15) :  SizedBox(width: AppSize.s30),
                          ...
                          providerState.isContactTrue ?SizedBox(width: 20,) : SizedBox(width: AppSize.s35),
                          providerState.isContactTrue ?Offstage() :  Flexible(child: SizedBox(width:55)),
                        ],
                      ),
                      SizedBox(height: AppSize.s16),
                      Row(
