...
class InsuranceSavePage extends StatelessWidget {
  ...
  const InsuranceSavePage({super.key, required this.onBack, required this.patientId});

  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Padding(
        padding: const EdgeInsets.only(right: 30,left: 55),
      ...
      SizedBox(height: 20,),
          ...
          Row(
            ...
            children: [
              Text('Insurance I',style: CustomTextStylesCommon.commonStyle(
              //  color:Color(0xFF575757),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("Verified",style: CustomTextStylesCommon.commonStyle(
                          //  color:Color(0xFF575757),
                          fontSize: FontSize.s14,
                          fontWeight: FontWeight.w700,
                          color: ColorManager.white,
                        )),
                        Image.asset("images/sm/white_tik.png",height: 20,)
...
///
  ...
  children: [
    Padding(
      ...
      child: IconButton(onPressed: (){}, icon: Icon(Icons.edit_outlined,color: ColorManager.bluebottom,),
        ...
        hoverColor: Colors.transparent,
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              Text('Insurance II',style: CustomTextStylesCommon.commonStyle(
                //  color:Color(0xFF575757),
                fontSize: FontSize.s16,
                fontWeight: FontWeight.w700,
                color: ColorManager.mediumgrey,
