                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: widget.suffixIcon,
                            hintText: widget.hintText,
                            hintStyle: DropdownItemStyle.customTextStyle(context),
                            prefixStyle:DropdownItemStyle.customTextStyle(context),// AllHRTableData.customTextStyle(context),
                            border: InputBorder.none,
                            contentPadding: EdgeInsets.only(bottom: 15, left: AppPadding.p15),
                          ),
                          style: DropdownItemStyle.customTextStyle(context),// TableSubHeading.customTextStyle(context),
                          //validator: widget.validator,
                          onTap: widget.onChange,
                          validator: widget.validator,
                          inputFormatters: widget.phoneField! ? [
